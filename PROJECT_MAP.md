...
- **المرحلة 3 (بدأت)** — أربع مقالات عربية موجّهة لنيّة البحث، وكل مقالة
  تنتهي بدعوة إلى الأداة التي يحتاجها قارئها (خريطة `TOOLS` في build.js)
...
| 4 | النسخة الإنجليزية ناقصة 7 مقالات (a8–a14) | ⏳ اتّسعت الفجوة بعد إضافة الأربع الجديدة |
